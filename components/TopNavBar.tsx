...
export default function TopNavbar() {
    ...
    function lockScroll () {
        ...
        root.classList.toggle("lock-scroll"); //class is defined in the global.css
    }
        ...
        >
            ...
            <Link href="/" passHref >
                <div className="flex gap-2 items-center cursor-pointer z-50">
                    ...
                    >
                        <h1 className="font-sarina text-xl">MN</h1>
                    </motion.a>
                    <motion.p
                    initial="hidden"
                    animate={control}
...
function NavItem ({href, text, router}) {
    ...
    return (
        <Link href={href==="/home" ? "/" :href} passHref>
            ...
            } sm:inline-block transition-all text-[17px] hidden px-2 md:px-3 py-[3x] hover:bg-gray-100 dark-hover:bg-neutral-700/50 rounderd-md`}
            >
        ...
        >
            {!open ? (
                <svg
                    ...
                    className="h-6 w-6 cursor-pointer select-none transform duration-300 rounderd-md active:scale-50"
                    onClick={handleClick}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
